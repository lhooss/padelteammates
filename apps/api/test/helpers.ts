...
export async function resetDb(): Promise<void> {
  await prisma.$executeRawUnsafe(
    'TRUNCATE TABLE "Notification","Score","JoinRequest","Participant","Match","Club","Friendship","FrmtLink","FrmtRankingEntry","FrmtImport","RefreshToken","PushToken","PasswordReset","User" RESTART IDENTITY CASCADE;',
  );
  await redis.flushdb();
}
